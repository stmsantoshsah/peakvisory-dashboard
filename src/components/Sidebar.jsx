...
const Sidebar = () => {
    ...
    const sidebarData = {
        ...
        menus: [
            {
                id: 1, name: "Dashboard", icon: dashboard, path: "/dashboard", badge: "Overview", submenus: [
                    { id: 11, name: "Overview", path: "/dashboard/overview" },
                    { id: 12, name: "Activity", path: "/dashboard/activity" },
                ]
            },
            {
                id: 2, name: "Accounting", icon: accountings, path: "/accounting", badge: "Financial Data", submenus: [
            ...
            {
                id: 3, name: "Banking", icon: banking, path: "/banking", badge: "Transactions", submenus: [
                    { id: 31, name: "Transactions", path: "/banking/transactions" },
                    { id: 32, name: "Accounts", path: "/banking/accounts" },
                ]
            },
            {
                id: 4, name: "Reports", icon: reports, path: "/reports", badge: "Analytics", submenus: [
            ...
            {
                id: 5, name: "Contacts", icon: contacts, path: "/contacts", badge: "People", submenus: [
                    { id: 51, name: "Clients", path: "/contacts/clients" },
                    { id: 52, name: "Suppliers", path: "/contacts/suppliers" },
                ]
            },
            {
                id: 6, name: "Invoicing", icon: invoicing, path: "/invoicing", badge: "Billing", submenus: [
            ...
            {
                id: 7, name: "Queries", icon: queries, path: "/queries", badge: "Support", submenus: [
                    { id: 71, name: "Customer Queries", path: "/queries/customers" },
                    { id: 72, name: "Technical Issues", path: "/queries/technical" },
                ]
            },
            {
                id: 8, name: "Help", icon: help, path: "/help", badge: "Guidance", submenus: [
            ...
            <ul className="sidebar-menu">
                {sidebarData.menus.map((menu) => (
                    ...
                    >
                        <Link
                            to={menu.path}
                            className="flex items-center gap-3 py-[15px] hover:bg-[#9C85ED] flex-col border-l-2 border-transparent hover:border-white"
                        >
                        ...
                        {menu.submenus && hoveredMenu === menu.id && (
                            <div className="absolute left-full top-0 pt-[74px] bg-[#9C85ED] h-full w-[200px] shadow-lg px-4 ">
                                <div className="bg-white text-primary text-sm px-2 py-2 rounded-[2px]">
                                    {menu.badge}
                                </div>
                                <ul >
                                    {menu.submenus.map((submenu) => (
                                        <li key={submenu.id} className="py-3 px-5 hover:bg-gray-600 pointer">
